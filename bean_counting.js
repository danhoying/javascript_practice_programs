...
// .charAt(N) , similar to how you get its length with "s".length . The
// returned value will be a string containing only one character (for example,
// "b" ). The first character has position zero, which causes the last one to
...
console.log(countChar("How are you doing today?", "a"));
console.log(countChar("Are you sure that's your father?", "r"));
